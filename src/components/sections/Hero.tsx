      ...
      <div className="max-w-6xl w-full mx-auto px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <div className="absolute inset-0 bg-gradient-to-tr from-[#4AACDE]/40 via-transparent to-[#1B7A2B]/20 blur-3xl opacity-70 rounded-[3rem] animate-pulse pointer-events-none" />

            {/* Central Glass Card */}
            <motion.div 
              whileHover={{ rotateY: -5, rotateX: 5, scale: 1.02 }}
              transition={{ type: "spring", stiffness: 300, damping: 20 }}
              className="glass-card rounded-[2.5rem] p-8 relative shadow-2xl shadow-[#0A2F4C]/15 border border-white/50 group transform-gpu z-10 bg-white/40 backdrop-blur-xl"
            >
              ...
              <div className="relative z-10">
                ...
                <div className="flex items-center justify-between mb-10">
                  <div className="flex items-center gap-2.5 px-4 py-2 rounded-full bg-white/60 border border-white/80 shadow-sm backdrop-blur-md">
                  ...
                  <div className="text-[11px] font-bold text-[#6B7280] uppercase tracking-wide bg-white/40 px-3 py-1.5 rounded-full border border-white/40">
                ...
                <div className="space-y-5 mb-10 relative">
                  ...
                  <motion.div 
                    ...
                    className="bg-white/90 backdrop-blur-md border border-white/60 rounded-2xl p-4 shadow-sm relative z-10 hover:shadow-md transition-shadow"
                  >
                  ...
                  <motion.div 
                    ...
                    className="bg-[#0A2F4C] border border-[#0A2F4C]/50 rounded-2xl p-4 shadow-xl ml-8 shadow-[#0A2F4C]/25 relative z-10"
                  >
                    <div className="flex items-start gap-4">
                      <div className="w-10 h-10 rounded-full bg-[#4AACDE]/20 flex items-center justify-center shrink-0 border border-[#4AACDE]/30">
                ...
                {/* Integration Row */}
                <div className="flex items-center justify-center gap-6 py-5 border-y border-white/30 mb-8 bg-white/30 rounded-2xl backdrop-blur-sm shadow-inner">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-full flex items-center justify-between bg-[#0A2F4C] text-white px-7 py-4 rounded-2xl font-semibold text-sm shadow-[0_8px_30px_rgb(10,47,76,0.3)] group hover:bg-[#001f35] transition-all hover:scale-[1.02] border border-transparent hover:border-white/20"
                >
            ...
            <motion.div 
              ...
              className="absolute -right-8 top-16 bg-white shadow-xl rounded-2xl p-3.5 border border-white/60 backdrop-blur-md flex items-center gap-3 z-20 transform rotate-3 hidden sm:flex"
            >
            ...
            <motion.div 
              ...
              className="absolute -left-6 bottom-24 bg-white shadow-xl rounded-2xl p-3 border border-white/60 backdrop-blur-md flex items-center gap-2 z-20 transform -rotate-6 hidden sm:flex"
            >
