            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="text-center bg-[#16213E] border border-[#0F4C75]/30 rounded-3xl p-12 shadow-xl">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                        <a href="https://calendly.com/quotadoctor/15min" target="_blank" rel="noopener noreferrer" className="bg-[#3282B8] text-white font-bold px-8 py-4 rounded-xl hover:bg-[#0F4C75] hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-[0_0_25px_rgba(50,130,184,0.5)]">Book Your Free AI Audit</a>
