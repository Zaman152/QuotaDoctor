            ...
            <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                ...
                >
                    ...
                    <div className="space-y-4 relative z-10">
                        ...
                        {/* Phone - Added Back */}
                        <a href="tel:17206062741" className="flex items-center justify-between p-4 rounded-xl bg-white/5 border border-white/5 hover:bg-[#3282B8] hover:border-[#3282B8] transition-all group/item">
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-white font-medium">1-720-606-2741</p>
                                </div>
                            </div>
                            <ArrowUpRight className="w-5 h-5 text-white/30 group-hover/item:text-white" />
                        </a>
